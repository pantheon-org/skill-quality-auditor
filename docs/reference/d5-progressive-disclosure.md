...
| --- | --- | --- |
| Security patterns, caching, and trigger configuration | [Best Practices](#best-practices) | Every time you generate a workflow |
| Pinned action versions and input/output specs | [Common Actions](#common-actions) | When using any public action |
...
| Reference column | Every cell MUST be a markdown link `[text]`(`<target>`) |
...
| Topic | Reference | When to Use |
| --- | --- | --- |
| Per-dimension criteria and bonus rules | [Dimensions](#dimensions) | Evaluating any individual dimension or understanding the rubric |
| Score thresholds and grade bands | [Scoring Rubric](#scoring) | Calculating a total score or assigning a grade — skip if only auditing structure |
```
