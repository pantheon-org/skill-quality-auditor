...
The 9-dimension quality framework and scoring methodology draw on the following research:
...
- Amarasinghe, Asanka et al., 2024 — [Code Quality Alarms: Techniques, Datasets, and Emerging Trends](https://jdrra.sljol.info/articles/10.4038/jdrra.v3i2.93)
...
- Paduraru, Zavelca, Stefanescu — [Agentic AI for Behaviour-Driven Development Testing](https://www.researchgate.net/publication/390835646)
...
- Kohl, Kruse, Mostafa, Luckow et al. — [Automated Structural Testing of LLM-Based Agents](https://ieeexplore.ieee.org/abstract/document/11401679/)
...
- Tao, 2025 — [LLM-Skill Orchestration](https://www.researchsquare.com/article/rs-9323974/latest)

### Pattern Recognition (D7)

- Zhang et al., 2025 — [AgentRouter: A Knowledge-Graph-Guided LLM Router for Collaborative Multi-Agent QA](https://arxiv.org/abs/2510.05445)
...
- Rehan, 2026 — [Test-Driven AI Agent Definition (TDAD)](https://arxiv.org/abs/2603.08806)
- Alami, 2026 — [Cognitive Camouflage: Specification Gaming in LLM-Generated Code](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6512960)
